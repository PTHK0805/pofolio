...
export default function AboutMe() {
  return (
    <motion.section
      ...
      viewport={{ once: false }}
      className="text-center mb-12 bg-white rounded-lg shadow-lg p-8"
    >
      <motion.div
        initial={{ scale: 0 }}
        whileInView={{ scale: 1 }}
      ...
      >
        <Image
          ...
          width={200}
          height={200}
          className="rounded-full mx-auto mb-4 border-4 border-x-cyan-100"
        />
      </motion.div>
      <motion.h1
        initial={{ opacity: 0 }}
        ...
        viewport={{ once: false }}
        className="text-4xl font-bold mb-2 text-sky-900"
      >
        Phyo Thiha Kyaw
      </motion.h1>
      <motion.h2
      ...
      <motion.a
        ...
        className="bg-gradient-to-r from-sky-600 to-blue-500 text-white px-6 py-2 rounded-full hover:from-sky-700 hover:to-blue-600 transition duration-300"
        target="_blank"
